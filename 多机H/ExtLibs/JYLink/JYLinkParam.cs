...
public partial class JYLink
{
    public class JYLinkParam
    {
        ...
        /// </summary>
        public JY_PARAM_TYPE Type { get; set; }

        private JY_PARAM_TYPE _typeap = JY_PARAM_TYPE.ENUM_END;
        public JY_PARAM_TYPE TypeAP
        {
            get 
            {
                if (_typeap != JY_PARAM_TYPE.ENUM_END) 
                    return _typeap;
                return Type;
            }
            set
        ...
        public JYLinkParam(string name, double value, JY_PARAM_TYPE type)
        {
            Name = name;
            Type = type;
            Value = value;
        ...
        public JYLinkParam(string name, byte[] inputwire, JY_PARAM_TYPE type, JY_PARAM_TYPE typeap)
        {
            Name = name;
            Type = type;
            TypeAP = typeap;
        ...
        public double GetValue()
        {
            switch (Type)
            {
                case JY_PARAM_TYPE.UINT8:
                    return (double)uint8_value;
                case JY_PARAM_TYPE.INT8:
                    return (double)int8_value;
                case JY_PARAM_TYPE.UINT16:
                    return (double)uint16_value;
                case JY_PARAM_TYPE.INT16:
                    return (double)int16_value;
                case JY_PARAM_TYPE.UINT32:
                    return (double)uint32_value;
                case JY_PARAM_TYPE.INT32:
                    return (double)int32_value;
                case JY_PARAM_TYPE.REAL32:
        ...
        public static explicit operator byte(JYLinkParam v)
        {
            return (byte)v.Value;
        }

        public static explicit operator sbyte(JYLinkParam v)
        {
            return (sbyte)v.Value;
        }

        public static explicit operator short(JYLinkParam v)
        {
            return (short)v.Value;
        }

        public static explicit operator ushort(JYLinkParam v)
        {
            return (ushort)v.Value;
        }

        public static explicit operator int(JYLinkParam v)
        {
            return (int)v.Value;
        }

        public static explicit operator uint(JYLinkParam v)
        {
            return (uint)v.Value;
        }

        public static explicit operator float (JYLinkParam v)
        {
            return (float)v.Value;
        }

        public static explicit operator double(JYLinkParam v)
        {
