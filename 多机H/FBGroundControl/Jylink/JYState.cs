...
namespace MissionPlanner
{
    public class JYState : JYLink
    {
        ...
        public JYState()
        {
            ...
            signing = false;
            this.param = new JYLinkParamList();
            this.packets = new Dictionary<uint, JYLinkMessage>();
            this.mcPackets = new Dictionary<uint, JYLinkMCMessage>();
            //this.aptype = 0;
            //this.apname = 0;
        ...
        /// </summary>
        public JYLinkParamList param { get; set; }

        public Dictionary<string, JY_PARAM_TYPE> param_types = new Dictionary<string, JY_PARAM_TYPE>();

        /// <summary>
        /// storage of a previous packet recevied of a specific type
        /// </summary>
        public Dictionary<uint, JYLinkMessage> packets { get; set; }

        public JYLinkMessage getPacket(uint mavlinkid)
        {
        ...
        public Dictionary<uint, JYLinkMCMessage> mcPackets { get; set; }

        public JYLinkMCMessage getMCPacket(uint mavlinkid)
        {
            //log.InfoFormat("getPacket {0}", (MAVLINK_MSG_ID)mavlinkid);
            if (mcPackets.ContainsKey(mavlinkid))
            {
                return mcPackets[mavlinkid];
            }

            return null;
        }

        public void clearMCPacket(uint mavlinkid)
        {
            if (mcPackets.ContainsKey(mavlinkid))
            {
                mcPackets[mavlinkid] = null;
            }
        }
        ...
        ///// mavlink ap type
        ///// </summary>
        //public JY_TYPE aptype { get; set; }

        //public JY_AUTOPILOT apname { get; set; }
        ...
        /// </summary>
        public Dictionary<int, jylink_mission_item> wps = new Dictionary<int, jylink_mission_item>();
