...
namespace MissionPlanner.Controls
{
    public class MavlinkComboBox : ComboBox
    {
        ...
        public void setup(List<KeyValuePair<int, string>> source, string paramname, JYLink.JYLinkParamList paramlist)
        ...
        public void setup(Type source, string paramname, JYLink.JYLinkParamList paramlist)
            //, string paramname2 = "", Control enabledisable = null)
        {
            base.SelectedIndexChanged -= MavlinkComboBox_SelectedIndexChanged;
        ...
        void MavlinkComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (_source != null)
            {
                try
                {
                    ...
                    //if (!MainForm.telecontrol_comPort.setParam(ParamName, (float)(Int32)Enum.Parse(_source, this.Text)))
                    //{
                    ...
                    //{
                    //    if (
                    //        !MainForm.telecontrol_comPort.setParam(paramname2,
            ...
            else if (_source2 != null)
            {
                try
                {
                    ...
                    //if (!MainForm.telecontrol_comPort.setParam(ParamName, (float)(int)((MavlinkComboBox)sender).SelectedValue))
                    //{
