...
namespace MissionPlanner.Controls
{
    public class MavlinkCheckBox : CheckBox
    {
        ...
        public void setup(double OnValue, double OffValue, string paramname, JYLink.JYLinkParamList paramlist,
        ...
        void MavlinkCheckBox_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (this.Checked)
            {
                ...
                try
                {
                    //bool ans = MainForm.telecontrol_comPort.setParam(ParamName, OnValue);
                    //if (ans == false)
            ...
            else
            {
                ...
                //try
                //{
                //    bool ans = MainForm.telecontrol_comPort.setParam(ParamName, OffValue);
                //    if (ans == false)
                //        CustomMessageBox.Show(String.Format(Strings.ErrorSetValueFailed, ParamName), Strings.ERROR);
                //}
                //catch
