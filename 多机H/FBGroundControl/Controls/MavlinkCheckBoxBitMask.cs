...
namespace MissionPlanner.Controls
{
    public class MavlinkCheckBoxBitMask : MyUserControl
    {
        ...
        JYLink.JY_PARAM_TYPE Type = JYLink.JY_PARAM_TYPE.REAL32;
        ...
        public float Value
        {
            get
            {
                ...
                // type conversions
                // ie int8 255 = -1
                if (Type == JYLink.JY_PARAM_TYPE.INT8)
                {
                    answer = (sbyte)answer;
                }
                else if (Type == JYLink.JY_PARAM_TYPE.INT16)
                {
                    answer = (short)answer;
                }
                else if (Type == JYLink.JY_PARAM_TYPE.INT32)
                {
                    answer = (int)answer;
                } 
        ...
        public void setup(string paramname, JYLink.JYLinkParamList paramlist)
        {
            ...
            if (paramlist.ContainsKey(paramname))
            {
                ...
                list = ParameterMetaDataRepository.GetParameterBitMaskInt(ParamName,
                    MainForm.comPort.JY.cs.firmware.ToString());
                chkcount = list.Count;
        ...
        void MavlinkCheckBoxBitMask_CheckedChanged(object sender, EventArgs e)
        {
            ...
            //try
            //{
            //    bool ans = MainForm.telecontrol_comPort.setParam(ParamName, Value);
            //    if (ans == false)
