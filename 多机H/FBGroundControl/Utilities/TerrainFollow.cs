...
namespace MissionPlanner.Utilities
{
    public class TerrainFollow
    {
        ...
        JYLink.JYLinkMessage lastmessage;
        //JYLink.mavlink_terrain_request_t lastrequest;

        KeyValuePair<JYLink.JYLINK_MSG_ID, Func<JYLink.JYLinkMessage, bool>> subscription;

        private JYLinkInterface _interface;

        public TerrainFollow(JYLinkInterface inInterface)
        {
        //    _interface = inInterface;

        //    log.Info("Subscribe to packets");
        //    subscription = _interface.SubscribeToPacketType(JYLink.JYLINK_MSG_ID.TERRAIN_REQUEST, ReceviedPacket);
        //}
        ...
        bool ReceviedPacket(JYLink.JYLinkMessage rawpacket)
        {
            return true;
