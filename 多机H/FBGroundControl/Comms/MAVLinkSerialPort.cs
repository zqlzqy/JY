...
namespace MissionPlanner.Comms
{
    ...
    public class MAVLinkSerialPort : ICommsSerial
    {
        ...
        JYLinkInterface mavint;

        static KeyValuePair<JYLink.JYLINK_MSG_ID, Func<JYLink.JYLinkMessage, bool>> subscription;

        uint baud = 0;

        public ushort timeout = 10;

        public JYLink.SERIAL_CONTROL_DEV port = JYLink.SERIAL_CONTROL_DEV.TELEM1;
        ...
        public MAVLinkSerialPort(JYLinkInterface mavint, int port)
            : this(mavint, (JYLink.SERIAL_CONTROL_DEV)port)
        {

        }

        public MAVLinkSerialPort(JYLinkInterface mavint, JYLink.SERIAL_CONTROL_DEV port)
        {
            this.mavint = mavint;
            this.port = port;
            ...
            //subscription = mavint.SubscribeToPacketType(JYLink.JYLINK_MSG_ID.SERIAL_CONTROL, ReceviedPacket, true);
        ...
        bool ReceviedPacket(JYLink.JYLinkMessage packet)
        {
            ...
            JYLink.jylink_serial_control_t item = packet.ToStructure<JYLink.jylink_serial_control_t>();
